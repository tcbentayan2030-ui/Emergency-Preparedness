...
(- Wireframe for interface layout (if applicable), and/or ---> this section can be included in the third quarter where concept of wireframe will be discussed)
- Pseudocode or Flowchart to describe the expected program flow.
